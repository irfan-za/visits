...
function InputLink() {
  return (
    <form action={createShortLink}>
        <div className="relative max-w-xl z-10 flex space-x-3 rounded-lg border border-gray-400 bg-white p-3 shadow-lg shadow-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:shadow-gray-900/[.2]">
