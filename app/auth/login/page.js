...
function Login() {
  return (
    <section class="dark:bg-slate-900 bg-gray-100 flex h-screen items-center py-16">
          ...
          <div class="p-4 sm:p-7">
            <div class="text-center">
              ...
              <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                Belum memiliki akun?
                <Link className="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="../examples/html/signup.html">
                  Daftar disini.
                </Link>
              </p>
            </div>
            ...
            <div class="mt-5">
              ...
              <div class="py-3 flex items-center text-xs text-gray-400 uppercase before:flex-[1_1_0%] before:border-t before:border-gray-200 before:me-6 after:flex-[1_1_0%] after:border-t after:border-gray-200 after:ms-6 dark:text-gray-500 dark:before:border-gray-600 dark:after:border-gray-600">Atau</div>
                ...
                <div class="grid gap-y-4">
                  ...
                  <div>
                    <div class="flex justify-between items-center">
                      ...
                      <Link class="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/auth/forgot-password">Lupa password?</Link>
                    </div>
                    <div class="relative">
                    ...
                    <p class="hidden text-xs text-red-600 mt-2" id="password-error">Password minimal 6 karakter</p>
                  </div>
                  {/* <!-- End Form Group --> */}
