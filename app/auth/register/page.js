           ...
           <div class="p-4 sm:p-7">
             <div class="text-center">
               ...
               <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                 Sudah memiliki akun?
                 <Link class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/auth/login">
                   Masuk disini.
                 </Link>
               </p>
             </div>
               ...
               <form>
                 <div class="grid gap-y-4">
                   ...
                   <div>
                     ...
                     <p class="hidden text-xs text-red-600 mt-2" id="name-error">Please include a valid email address so we can get back to you</p>
                   </div>
                   {/* <!-- End Form Group --> */}
                   ...
                   {/* <!-- Form Group --> */}
                   <div>
                     <label for="confirm-password" class="block text-sm mb-2 dark:text-white">Konfirmasi Password</label>
                     <div class="relative">
