...
function DarkModeToggle() {
  ...
  return (
    <button  
          ...
          type="button" 
          className="w-[2.375rem] h-[2.375rem] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-800 dark:text-white hover:bg-white/20 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 dark:focus:ring-gray-300 focus:ring-gray-700">
          {
            currentTheme ==='light'?
