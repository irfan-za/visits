    ...
    <header className="fixed flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-gray-100 dark:bg-gray-800 drop-shadow-lg text-sm sm:text-base py-3 sm:py-4 top-0">
      <nav className="relative max-w-[85rem] w-full mx-auto px-4 flex sm:items-center sm:justify-between sm:px-6 lg:px-8" ariaLabel="Global">
          ...
          <div className="inline-flex items-center justify-end grow gap-x-4">
            ...
            <Link className="flex items-center font-medium text-white bg-gradient-to-r bg-blue-500 hover:bg-blue-600 rounded-md px-2 py-1 sm:px-4 sm:py-1.5" href="/auth/login">
              Masuk
            </Link>
          </div>
      </nav>
